...
/-!
# Jacobi boundaries for free metabelian Lie rings

This file contains only the elementary alternating boundary used to present
the homogeneous pieces of a free metabelian Lie ring, together with its
explicit formula and the identity that consecutive boundaries compose to
zero.  It has no homological-algebra or resolution machinery.
-/

open TensorProduct

namespace FreeMetabelian.JacobiBoundary
...
/-- One summand in the alternating symmetric boundary, before alternating
uncurrying. -/
...
/-- The integral alternating symmetric boundary
...
/-- Consecutive alternating symmetric boundaries compose to zero. -/
...
end FreeMetabelian.JacobiBoundary
